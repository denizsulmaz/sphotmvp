...
export const metadata = {
  ...
  description: "How users and photographers keep SPHOT safe, respectful, and reliable.",
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8 py-12">
      ...
      <div className="space-y-10 text-gray-600 dark:text-zinc-400 leading-relaxed">
        <section>
          <p>
            SPHOT works because users and photographers treat each other with respect and honesty.
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground dark:text-white mb-4 flex items-center gap-2">
            <Heart size={20} className="text-foreground dark:text-accent" /> For Everyone
          </h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground dark:text-white mb-4 flex items-center gap-2">
            <Users size={20} className="text-foreground dark:text-accent" /> For Users
          </h2>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground dark:text-white mb-4 flex items-center gap-2">
            <Camera size={20} className="text-foreground dark:text-accent" /> For Photographers
          </h2>
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>Keep pricing transparent.</strong> Be clear about your rates and what&apos;s included before the user commits. No surprise or off-platform charges to avoid fees.</li>
            <li><strong>Honor confirmed bookings.</strong> Approve, decline, or reschedule promptly. Don&apos;t no-show. If you must cancel, tell the user as early as possible.</li>
            ...
            <li><strong>Keep your profile current.</strong> Accurate availability, categories, and locations so users book with confidence.</li>
          </ul>
        </section>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground dark:text-white mb-4 flex items-center gap-2">
            <ShieldCheck size={20} className="text-foreground dark:text-accent" /> Reporting &amp; Enforcement
          </h2>
          <p className="mb-3">
